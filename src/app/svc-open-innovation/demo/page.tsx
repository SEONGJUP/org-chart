        ...
        <div className="grid grid-cols-2 gap-3 md:grid-cols-3 xl:grid-cols-4">
          {features.map((feature) => (
            <Link
              ...
              className="min-h-[166px] rounded-2xl border border-slate-200 bg-white p-3 text-left shadow-sm transition hover:-translate-y-0.5 hover:border-teal-300 hover:shadow-lg"
            >
          ...
          <button onClick={addFeature} className="min-h-[166px] rounded-2xl border-2 border-dashed border-slate-300 bg-white p-3 text-left transition hover:border-teal-300 hover:bg-teal-50/50">
